 ...
 */
@Component({
    selector: "devops-page",
    templateUrl: "devops.page.html",
    styleUrls: ["devops.page.css"]
})
export class DevopsPageComponent extends AbstractPageComponent {
    ...
    protected pageTitle(): string {
        return "Boilerplate - Documents - DevOps";
    }

    public loadAsyncPageData(): void {
        console.log("[DevopsPageComponent] loadAsyncPageData")
    }
