...
@Component({
    ...
    styleUrls: ["architecture.page.css"]
})
export class ArchitecturePageComponent extends AbstractPageComponent {
    ...
    protected pageTitle(): string {
        return "Boilerplate - Documents - Architecture";
    }

    public loadAsyncPageData(): void {
        console.log("[ArchitecturePageComponent] loadAsyncPageData")
    }
