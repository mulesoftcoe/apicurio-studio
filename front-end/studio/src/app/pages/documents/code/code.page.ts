...
@Component({
    ...
    styleUrls: ["code.page.css"]
})
export class CodePageComponent extends AbstractPageComponent {
    ...
    protected pageTitle(): string {
        return "Boilerplate - Documents - Code";
    }

    public loadAsyncPageData(): void {
        console.log("[CodePageComponent] loadAsyncPageData")
    }
