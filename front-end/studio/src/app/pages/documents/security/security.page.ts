...
/**
 * The Documents/security Page component.
 */
@Component({
...
export class SecurityPageComponent extends AbstractPageComponent {
    ...
    protected pageTitle(): string {
        return "Boilerplate - Documents - Security";
    }

    public loadAsyncPageData(): void {
        console.log("[SecurityPageComponent] loadAsyncPageData")
    }
